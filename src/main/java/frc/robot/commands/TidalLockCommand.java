...
public class TidalLockCommand extends Command {
  ...
  @Override
  public void execute() {
    drivetrain.setControl(request.withRotationalRate(new TidalLock().getOutput(drivetrain.getGlobalPose().getRotation().getDegrees(), drivetrain.getAngleToHub().getDegrees(), drivetrain.getFieldRelativeChassisSpeeds().vyMetersPerSecond)));
  }
